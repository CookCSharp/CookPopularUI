    ...
    public class ControlBorderBehavior : Behavior<Control>
    {
        ...
        private class BorderAnimationPath : Shape
        {
            ...
            static BorderAnimationPath()
            {
                ...
                StrokeThicknessProperty.AddOwner(typeof(BorderAnimationPath), new FrameworkPropertyMetadata(CookPopularToolkit.ValueBoxes.Double5Box, FrameworkPropertyMetadataOptions.AffectsRender, OnPropertiesValueChanged));
            }
