...
namespace CookPopularUI.WPF.Controls
{
    ...
    public class TextBoxBaseAssistant
    {
        ...
        internal static void SetIsFirstChecked(DependencyObject obj, bool value) => obj.SetValue(IsFirstCheckedProperty, CookPopularToolkit.ValueBoxes.BooleanBox(value));
        internal static readonly DependencyProperty IsFirstCheckedProperty =
            DependencyProperty.RegisterAttached("IsFirstChecked", typeof(bool), typeof(TextBoxBaseAssistant), new PropertyMetadata(CookPopularToolkit.ValueBoxes.FalseBox, OnValueChanged));


        internal static bool GetIsGotFocus(DependencyObject obj) => (bool)obj.GetValue(IsGotFocusProperty);
        internal static void SetIsGotFocus(DependencyObject obj, bool value) => obj.SetValue(IsGotFocusProperty, CookPopularToolkit.ValueBoxes.BooleanBox(value));
        /// <summary>
        /// 是否启用省略号，如果启用了，就会截断文字，显示省略号。当文本获取焦点时，暂时失效
        /// </summary>
        internal static readonly DependencyProperty IsGotFocusProperty =
            DependencyProperty.RegisterAttached("IsGotFocus", typeof(bool), typeof(TextBoxBaseAssistant), new PropertyMetadata(CookPopularToolkit.ValueBoxes.FalseBox, OnValueChanged));


        public static bool GetIsTrimming(DependencyObject obj) => (bool)obj.GetValue(IsTrimmingProperty);
        public static void SetIsTrimming(DependencyObject obj, bool value) => obj.SetValue(IsTrimmingProperty, CookPopularToolkit.ValueBoxes.BooleanBox(value));
        /// <summary>
        /// <see cref="IsTrimmingProperty"/>表示是否裁剪文本
        /// </summary>
        public static readonly DependencyProperty IsTrimmingProperty =
            DependencyProperty.RegisterAttached("IsTrimming", typeof(bool), typeof(TextBoxBaseAssistant), new PropertyMetadata(CookPopularToolkit.ValueBoxes.FalseBox, OnValueChanged));
        ...
        public static void SetIsShowToolTip(DependencyObject obj, bool value) => obj.SetValue(IsShowToolTipProperty, CookPopularToolkit.ValueBoxes.BooleanBox(value));
        /// <summary>
        ...
        public static readonly DependencyProperty IsShowToolTipProperty =
            DependencyProperty.RegisterAttached("IsShowToolTip", typeof(bool), typeof(TextBoxBaseAssistant), new PropertyMetadata(CookPopularToolkit.ValueBoxes.FalseBox, OnValueChanged));
        ...
        private static bool CheckTextIsLongger(TextBoxBase control, string text)
        {
            ...
            FormattedText formattedText = new FormattedText(text, CurrentCulture, control.FlowDirection, typeface, control.FontSize, control.Foreground, DpiHelper.GetScaleX());
        ...
        private static string? SetEllipsisForText(TextBoxBase control, string text, EllipsisPlacement placement)
        {
            ...
            Typeface typeface = new Typeface(control.FontFamily, control.FontStyle, control.FontWeight, control.FontStretch);
            FormattedText formattedText = new FormattedText(text, CurrentCulture, control.FlowDirection, typeface, control.FontSize, control.Foreground, DpiHelper.GetScaleX());
            FormattedText ellipsisFormattedText = new FormattedText("\u2026", CurrentCulture, control.FlowDirection, typeface, control.FontSize, control.Foreground, DpiHelper.GetScaleX());
        ...
        private static int FindPosition(TextBoxBase control, string str, Typeface typeface, double clearButtonWidth, EllipsisPlacement placement)
        {
            ...
            while (start <= end)
            {
                ...
                FormattedText formattedText = new FormattedText(strTemp, CurrentCulture, control.FlowDirection, typeface, control.FontSize, control.Foreground, DpiHelper.GetScaleX());
                FormattedText ellipsisFormattedText = new FormattedText("\u2026", CurrentCulture, control.FlowDirection, typeface, control.FontSize, control.Foreground, DpiHelper.GetScaleX());
