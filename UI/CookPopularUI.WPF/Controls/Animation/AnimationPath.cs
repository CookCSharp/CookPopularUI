...
namespace CookPopularUI.WPF.Controls
{
    ...
    public class AnimationPath : Shape
    {
        ...
        public static readonly DependencyProperty DataProperty =
            DependencyProperty.Register(nameof(Data), typeof(Geometry), typeof(AnimationPath), new FrameworkPropertyMetadata(default(Geometry), OnValuePropertyChanged));
        ...
        public static readonly DependencyProperty PathLengthProperty =
            DependencyProperty.Register(nameof(PathLength), typeof(double), typeof(AnimationPath),
        ...
        public static readonly DependencyProperty DurationProperty =
            DependencyProperty.Register(nameof(Duration), typeof(Duration), typeof(AnimationPath),
        ...
        public static readonly DependencyProperty RepeatBehaviorProperty =
            DependencyProperty.Register(nameof(RepeatBehavior), typeof(RepeatBehavior), typeof(AnimationPath),
        ...
        public bool IsPlay
        {
            ...
            set { SetValue(IsPlayProperty, ValueBoxes.BooleanBox(value)); }
        }
        public static readonly DependencyProperty IsPlayProperty =
            DependencyProperty.Register(nameof(IsPlay), typeof(bool), typeof(AnimationPath),
        ...
        public static readonly RoutedEvent CompletedEvent =
            EventManager.RegisterRoutedEvent(nameof(Completed), RoutingStrategy.Bubble, typeof(EventHandler), typeof(AnimationPath));
        ...
        private void UpdatePath()
        {
            ...
            if (CookPopularToolkit.MathHelper.IsVerySmall(_pathLength)) return;
