...
{
    /// <summary>
    /// 表示<see cref="ListView"/>.<see cref="GridView"/>.<see cref="GridViewColumn"/>的附加属性基类
    /// </summary>
    [Obsolete("暂时无效", false)]
    public class GridViewColumnAssistant
    {
        ...
        private static void OnColumnMinWidthChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                var defaultGridViewColumnHeaderStyle = CookPopularToolkit.Windows.ResourceHelper.GetResource<Style>(typeof(GridViewColumnHeader));
    ...
    public class ListViewAssistant
    {
        ...
        public static readonly DependencyProperty ColumnHeaderPaddingProperty =
            DependencyProperty.RegisterAttached("ColumnHeaderPadding", typeof(Thickness), typeof(ListViewAssistant), new PropertyMetadata(default(Thickness), OnColumnHeaderPaddingChanged));
