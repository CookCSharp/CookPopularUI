    ...
    public class GroupLabel : ItemsControl
    {
        ...
        public GroupLabel()
        {
            CommandBindings.Add(new CommandBinding(CloseCommand, (s, e) =>
            {
                ...
                var label = ((FrameworkElement)e.OriginalSource).TemplatedParent as Label;
        ...
        public event RoutedPropertySingleEventHandler<object> ItemClosed
        {
        ...
        public static readonly RoutedEvent ItemClosedEvent =
            EventManager.RegisterRoutedEvent("ItemClosed", RoutingStrategy.Bubble, typeof(RoutedPropertySingleEventHandler<object>), typeof(GroupLabel));
