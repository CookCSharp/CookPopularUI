...
namespace CookPopularUI.WPF.Controls
{
    ...
    public class TextPath : Shape
    {
        ...
        public static readonly DependencyProperty DataProperty =
            DependencyProperty.Register(nameof(Data), typeof(Geometry), typeof(TextPath),
        ...
        {
            get => (ImageSource)GetValue(FillImageSourceProperty);
            set => SetValue(FillImageSourceProperty, value);
        }
        /// <summary>
        /// 提供<see cref="FillImageSource"/>的依赖属性
        /// </summary>
        public static readonly DependencyProperty FillImageSourceProperty =
            DependencyProperty.Register(nameof(FillImageSource), typeof(ImageSource), typeof(TextPath),
        ...
        /// 获取或设置在其中绘制图像的区域
        /// </summary>
        public Rect DrawingRec
        {
            get => (Rect)GetValue(DrawingRecProperty);
            set => SetValue(DrawingRecProperty, value);
        }
        /// <summary>
        /// 提供<see cref="DrawingRec"/>的依赖属性
        /// </summary>
        public static readonly DependencyProperty DrawingRecProperty =
            DependencyProperty.Register(nameof(DrawingRec), typeof(Rect), typeof(TextPath),
        ...
        {
            get => (Brush)GetValue(DrawingBrushProperty);
            set => SetValue(DrawingBrushProperty, value);
        }
        /// <summary>
        /// 提供<see cref="DrawingBrush"/>的依赖属性
        /// </summary>
        public static readonly DependencyProperty DrawingBrushProperty =
            DependencyProperty.Register(nameof(DrawingBrush), typeof(Brush), typeof(TextPath),
