...
namespace CookPopularUI.WPF.Controls
{
    ...
    internal class PolylineData
    {
        ...
        public Vector SmoothNormal(int index, double fraction, double cornerRadius)
        {
            if (cornerRadius > 0.0)
            {
                ...
                if (MathHelper.IsVerySmall(num))
                {
                    ...
                    return this.Normals[num3].Lerp(this.Normals[num2], 0.5).Normalized();
                }
                else
                {
                    ...
                    if (fraction <= num4)
                    {
                        ...
                        if (num5 >= 0)
                        {
                            ...
                            return this.Normals[index].Lerp(this.Normals[num5], alpha).Normalized();
                        }
                    }
                    else if (fraction >= 1.0 - num4)
                    {
                        ...
                        if (num6 < this.Count)
                        {
                            ...
                            return this.Normals[index].Lerp(this.Normals[num6], alpha2).Normalized();
                        }
                    }
                }
            }
        ...
        private IList<Vector> ComputeNormals()
        {
            ...
            {
                this.normals[i] = this.points[i].Normal(this.points[i + 1]);
            }
        ...
        private IList<double> ComputeAngles()
        {
            ...
            {
                this.angles[i] = -this.Normals[i - 1].Dot(this.Normals[i]);
            }
            if (this.IsClosed)
            {
                double value = -this.Normals[0].Dot(this.Normals[this.Count - 2]);
