...
namespace CookPopularUI.WPF.Controls
{
    ...
    public abstract class PrimitiveShape : Shape, IGeometrySourceParameters, IShape
    {
        ...
        static PrimitiveShape()
        {
            ...
            StrokeThicknessProperty.OverrideMetadata(typeof(PrimitiveShape), new DrawingPropertyMetadata(CookPopularToolkit.ValueBoxes.Double1Box, DrawingPropertyMetadataOptions.AffectsRender));
        }
