...
namespace CookPopularUI.WPF.Controls
{
    ...
    public sealed class GeometryEffectConverter : TypeConverter
    {
        ...
        public override object? ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                foreach (KeyValuePair<string, GeometryEffect> keyValuePair in registeredEffects)
                {
                    if ((keyValuePair.Value == null) ? (value == null) : keyValuePair.Value.Equals((GeometryEffect)value))
                    {
