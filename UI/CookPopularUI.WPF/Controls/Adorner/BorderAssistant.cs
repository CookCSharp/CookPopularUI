...
namespace CookPopularUI.WPF.Controls
{
    ...
    public class BorderAssistant
    {
        ...
        public static void SetIsCircular(DependencyObject obj, bool value) => obj.SetValue(IsCircularProperty, CookPopularToolkit.ValueBoxes.BooleanBox(value));
        /// <summary>
        /// <see cref="IsCircularProperty"/>标识是否满圆角
        /// </summary>
        public static readonly DependencyProperty IsCircularProperty =
            DependencyProperty.RegisterAttached("IsCircular", typeof(bool), typeof(BorderAssistant), new PropertyMetadata(CookPopularToolkit.ValueBoxes.FalseBox, OnIsCircularChanged));
