/*
 *Description: IfExtension
 *Author: Chance.zheng
 *Creat Time: 2023/11/22 14:04:27
 *.Net Version: 4.6
...
namespace CookPopularToolkit.Windows
{
    public class IfExtension : MultiBindingExtensionBase
    {
        ...
        public System.Windows.Data.Binding Condition
        {
        ...
        public IfExtension(System.Windows.Data.Binding condition, object trueValue, object falseValue) : this()
        {
            Condition = condition;
            True = trueValue;
            False = falseValue;
        ...
        private class MultiValueConverter : IMultiValueConverter
        {
            ...
            public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
            {
                ...
                if (condition == DependencyProperty.UnsetValue) return System.Windows.Data.Binding.DoNothing;

                return condition.CastTo<bool>() ? GetValue(_ifExtension._trueIndex, _ifExtension._true)
