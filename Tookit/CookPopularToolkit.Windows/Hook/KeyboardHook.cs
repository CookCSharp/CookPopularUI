...
namespace CookPopularToolkit.Windows
{
    internal class KeyboardHook
    {
        ...
        private InteropMethods.HookProc _hookProcDelegateToAvoidGC;
        /// <summary>
        ...
        private IntPtr SetHook(InteropMethods.HookProc proc)
        {
            ...
            {
                return InteropMethods.SetWindowsHookEx((int)InteropValues.HookType.WH_KEYBOARD_LL, proc, InteropMethods.GetModuleHandle(curModule.ModuleName), 0);
            }
            return IntPtr.Zero;
        }
    ...
    public class KeyboardWatcher
    {
        ...
        private async Task ConsumeKeyAsync()
        {
            while (isRunning)
            {
                ...
                OnKeyInput?.Invoke(null, (KeyboardHookEventArgs)item);
            }
        }
    }
}
