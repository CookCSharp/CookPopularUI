...
namespace CookPopularToolkit.Windows
{
    internal class MouseHook
    {
        ...
        private readonly InteropMethods.HookProc Proc;
        ...
        private IntPtr SetHook(InteropMethods.HookProc proc)
        {
        ...
        private IntPtr HookCallback(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            MouseAction.Invoke(null, new MouseHookEventArgs { MessageType = (MouseMessageType)wParam, Point = new InteropValues.POINT(hookStruct.pt.X, hookStruct.pt.Y), MouseData = hookStruct.mouseData });
    ...
    public class MouseWatcher
    {
        ...
        private async Task ConsumeKeyAsync()
        {
            while (isRunning)
            {
                ...
                OnMouseInput?.Invoke(null, (MouseHookEventArgs)item);
            }
        }
    }
}
