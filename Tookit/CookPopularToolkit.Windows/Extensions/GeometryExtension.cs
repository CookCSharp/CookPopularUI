...
namespace CookPopularToolkit.Windows
{
    ...
    public static class GeometryExtension
    {
        ...
        /// <returns></returns>
        public static Geometry GetGeometryFromText(this string textToFormat, double fontSize = 12, FontFamily? fontFamily = null, FontStyle? fontStyle = null, FontWeight? fontWeight = null, FontStretch? fontStretch = null)
        {
            //var pixelsPerDip = VisualTreeHelper.GetDpi(visual) / 96.0;
            ...
            var formattedText = new FormattedText(textToFormat,
