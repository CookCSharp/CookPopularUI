...

{
    ...
    {
        private static readonly RegularPatterns _default = new RegularPatterns();
        public static RegularPatterns Default => _default;
        /// <summary>
        ...
        /// 16进制颜色规则
        /// </summary>
        public const string HexColorPatter = "^[#+0-9|a-f|A-F]+$";



        public bool IsMatchRegularPattern(string inputText, InputTextType formatType = default)
        {
            return Regex.IsMatch(inputText, GetValue(Enum.GetName(typeof(InputTextType), formatType) + "Pattern"));
        }
